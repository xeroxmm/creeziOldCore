  ...
  function testAPI(response) {
    ...
    FB.api('/me', function(responseX) {
      ...
      document.getElementById('nav-settings').innerHTML =
        'Thanks for logging in, ' + response.name + '! <img id="sign-in-pic" src="http://graph.facebook.com/'+response.id+'/picture" height="30px"  width="30px" style="float: right"/>';
